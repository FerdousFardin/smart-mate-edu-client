...
export const Courses = () => {
  return (
    <div className="bg-[url(https://i.ibb.co/V3zsLDZ/bg7.jpg)] w-full h-full bg-cover flex flex-col gap-2 justify-center items-center">
      <h1 className="font-extralight text-4xl text-white text-center">
      ...
      <h3 className="text-2xl text-white text-center my-5">
      ...
      <button
        className="bg-[#a3ce54] rounded-full border border-[#a3ce54] hover:bg-base-100 hover:text-[#a3ce54] text-white font-bold py-2 lg:py-4 px-4 lg:px-8 focus:outline-none focus:shadow-outline duration-200"
        type="submit"
      >
        Browse All Courses
      </button>
