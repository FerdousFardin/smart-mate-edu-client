...
export const Error = () => {
  return (
    <section className="w-full h-screen flex justify-center items-center flex-col gap-2">
      ...
      <Link
        to="/"
        className="uppercase py-4 px-12 border-2 border-[#a3ce54] border-opacity-0 rounded-full hover:border-opacity-100 font-medium text-base-100 bg-[#a0ce4e] hover:bg-base-100 hover:text-[#a3ce54] duration-200 cursor-pointer"
      >
        Take me Home
      </Link>
    </section>
